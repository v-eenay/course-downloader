...
LOCAL_CONF_FILE_NAME = 'downloader.conf'
...
def parse_args(args=None):
    ...
    group_material.add_argument(
        ...
        action='store_true',
        default=False,
        help='treat slug inputs as specialization slugs and download all '
        'child courses into a specialization folder; specialization URLs '
        'are auto-detected. Note that there are name clashes, e.g. '
        '"machine-learning" is both a course and a specialization '
        '(Default: False)')
    ...
    group_material.add_argument(
        ...
        action='store',
        default=general.DEFAULT_VIDEO_RESOLUTION,
        help='preferred video resolution to download (default: best); '
        'only valid for on-demand courses; '
        'examples: best, 1080p, 1440p, 2160p')
    ...
    group_adv_auth.add_argument(
        ...
        action='store',
        default=None,
        choices=general.ALLOWED_BROWSERS,
        metavar="BROWSER",
